...
class Cache:
    ...
    async def set_task_id(self, task_id: int, hash_file: str):
        try:
    ...
    async def delete_task_id(self, task_id: int):
        try:
    ...
    async def set_llm_response(self, hash_file: str, llm_response: str):
        try:
            logger.debug(f'Start set_llm_response with params: {hash_file, llm_response}')
